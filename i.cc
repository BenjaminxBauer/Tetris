...
void I::set_ellipse_parameters(GLfloat nminor_axis, GLfloat nmajor_axis,
...
void I::get_ellipse_parameters(GLfloat &nminor_axis, GLfloat &nmajor_axis,
				    GLfloat &nangle_offset, 
				    GLfloat &nangular_velocity)
{
